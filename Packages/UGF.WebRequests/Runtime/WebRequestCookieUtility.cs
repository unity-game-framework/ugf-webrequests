...
{
    public static class WebRequestCookieUtility
    {
        public static List<WebResponseCookie> ParseCookieCollection(string value)
        {
            var result = new List<WebResponseCookie>();
        ...
        public static void ParseCookieCollection(string value, ICollection<WebResponseCookie> result)
        {
            ...
            {
                WebResponseCookie cookie = ParseCookie(cookieValue.Trim());
        ...
        public static bool TryParseCookie(string value, out WebResponseCookie cookie)
        {
            try
            {
        ...
        public static WebResponseCookie ParseCookie(string value)
        {
            if (string.IsNullOrEmpty(value)) throw new ArgumentException("Value cannot be null or empty.", nameof(value));
        ...
        public static string FormatCookieCollection(IReadOnlyList<WebResponseCookie> collection)
        {
            ...
            {
                WebResponseCookie cookie = collection[i];
        ...
        public static string FormatCookie(WebResponseCookie cookie)
        {
            if (!cookie.IsValid()) throw new ArgumentException("Value should be valid.", nameof(cookie));
